if (window.innerWidth >=1200) {
    ...
    document.body.innerHTML = `this game doesnt support this device, because your screen is ${window.innerWidth}x${window.innerHeight}. and it needs to be atleast 1200xXX.\nin the future i will fix the css & js to support smaller devices, sorry that you cant play.`
}