if (window.innerWidth <= 1000) {
    document.body.innerHTML = 'this game doesnt support phones or small devices \n i will fix this in the future'
}
else {
    ...
    updateColor()
    let maxNum = 100;
    //maxNum = JSON.parse(localStorage.getItem('max'))
    //if(maxNum === null) (maxNum = 100)
    let minNum = 0;
    //minNum = JSON.parse(localStorage.getItem('min'))
